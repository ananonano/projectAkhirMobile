...
class _AdminVouchersScreenState extends State<AdminVouchersScreen> {
  ...
  void _deleteVoucher(int voucherId) async {
    showDialog(
      context: context,
          ...
          : _vouchers.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.local_offer_rounded, size: 64, color: AppColors.primary.withOpacity(0.3)),
                      const SizedBox(height: 16),
                      const Text('Belum ada voucher', style: TextStyle(fontSize: 16, color: AppColors.textSecondary)),
                    ],
                  ),
                )
              : ListView.builder(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: voucher.isUsed ? Colors.grey.withOpacity(0.3) : Colors.green.withOpacity(0.2),
